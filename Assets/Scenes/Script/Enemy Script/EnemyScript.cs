...
public class EnemyScript : MonoBehaviour{
    ...
    void Awake(){
        anim = GetComponentInChildren<Animator>();  //  será que foi esse erro?
        anim.Play("Walk");
    ...
    void CheckToShoot(){
        if (canShoot){
            ...
            audioManager.Stop();
            right_Muzzle_Emission.rateOverTime = left_Muzzle_Emission.rateOverTime = 0f; // se nao bater é zero
